    ...
    return _then(_value.copyWith(
        ...
        vestibular: vestibular == freezed
            ...
            : vestibular // ignore: cast_nullable_to_non_nullable
                as bool,
        back: back == freezed ? _value.back : back as bool));
  }
}
...
class _$_BodyParts extends _BodyParts {
  const _$_BodyParts(
      ...
      this.leftUpperArm = false,
      this.leftElbow = false,
      this.leftLowerArm = false,
      this.leftHand = false,
      this.rightShoulder = false,
      this.rightUpperArm = false,
      this.rightElbow = false,
      this.rightLowerArm = false,
      this.rightHand = false,
      this.upperBody = false,
      this.lowerBody = false,
      this.leftUpperLeg = false,
      this.leftKnee = false,
      this.leftLowerLeg = false,
      this.leftFoot = false,
      this.rightUpperLeg = false,
      this.rightKnee = false,
      this.rightLowerLeg = false,
